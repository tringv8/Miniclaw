...
from miniclaw.config.paths import get_media_dir
from miniclaw.config.schema import Base
from miniclaw.security.network import validate_url_target
from miniclaw.utils.helpers import split_message
...
class TelegramChannel(BaseChannel):
    ...
    async def start(self) -> None:
        ...
        # Khi không cấu hình proxy, tắt trust_env để httpx không đọc HTTP_PROXY/HTTPS_PROXY
        # từ biến môi trường (tránh lỗi ConnectError nếu env có proxy không hợp lệ).
        httpx_kwargs: dict = {} if proxy else {"trust_env": False}
    ...
    async def _on_start(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        await update.message.reply_text(
            f"👋 Xin chào {user.first_name}! Tôi là miniclaw.\n\n"
            "Gửi tin nhắn cho tôi và tôi sẽ trả lời!\n"
