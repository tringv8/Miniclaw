...
from miniclaw.agent.memory import MemoryConsolidator
...
class AgentLoop:
    ...
    def __init__(
        ...
        # miniclaw_MAX_CONCURRENT_REQUESTS: <=0 means unlimited; default 3.
        _max = int(os.environ.get("miniclaw_MAX_CONCURRENT_REQUESTS", "3"))
    ...
    async def _connect_mcp(self) -> None:
        ...
        from miniclaw.agent.tools.mcp import connect_mcp_servers
        try:
    ...
    def _strip_think(text: str | None) -> str | None:
        ...
        if not text:
            return None
        from miniclaw.utils.helpers import strip_think
