...
if TYPE_CHECKING:
    from miniclaw.providers.registry import ProviderSpec
...
_DEFAULT_OPENROUTER_HEADERS = {
    "HTTP-Referer": "https://github.com/HKUDS/miniclaw",
    "X-OpenRouter-Title": "miniclaw",
...
def _uses_openrouter_attribution(spec: "ProviderSpec | None", api_base: str | None) -> bool:
    """Apply miniclaw attribution headers to OpenRouter requests by default."""
