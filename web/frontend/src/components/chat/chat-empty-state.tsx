  ...
  if (!isConnected) {
    return (
      <div className="flex flex-col items-center justify-center py-20 opacity-70">
        ...
        <h3 className="mb-2 text-xl font-medium">Chat service unavailable</h3>
        <p className="text-muted-foreground mb-4 text-center text-sm">
          The launcher could not establish the web chat connection. Reload the
          page or verify your model and provider settings.
        </p>
      </div>
    )
  }
