...
def _make_loop(*, exec_config=None):
    ...
    with patch("miniclaw.agent.loop.ContextBuilder"), \
         ...
         patch("miniclaw.agent.loop.SubagentManager") as MockSubMgr:
...
class TestHandleStop:
    ...
    async def test_stop_no_active_task(self):
        ...
        from miniclaw.command.builtin import cmd_stop
...
class TestSubagentCancellation:
    ...
    async def test_subagent_preserves_reasoning_fields_in_tool_turn(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setattr("miniclaw.agent.tools.registry.ToolRegistry.execute", fake_execute)
